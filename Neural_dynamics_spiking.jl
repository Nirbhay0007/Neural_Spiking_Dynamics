...
# ╔═╡ e271bbde-7cac-48d1-9fb6-80541df3afa2
using DifferentialEquations ,Plots,PlutoUI



# ╔═╡ 43ecae14-168d-44c0-840a-ede57b9cf1d1
md"""
# Phase 2: Building the Simulator

Welcome to Phase 2 of our mission. In [Phase 1](https://github.com/Nirbhay0007/Neural_Spiking_Dynamics/blob/main/Dynamical_system_of_Neuron.ipynb), we established the theoretical framework for the Hodgkin-Huxley model. Now, our objective is to translate that theory into a functional simulator using Julia.
...
# ╔═╡ dbca6abc-775e-4bee-9d30-10e91d8c9980
md"""
...
# ╔═╡ 326830ff-7cd0-497b-9a88-35a2061f7a6d
md"""
...
# ╔═╡ 7089e3b5-3858-4d45-83df-10378bfca534
md"""
## 4. Steady-State & Time Constant Functions

From the rate constants, we can derive the **steady-state activation/inactivation** (`x_∞`) and the **time constant** (`τₓ`) for each gate `x ∈ {m, h, n}`.

The general forms are:

```math
x_∞(V) = \frac{\alpha_x(V)}{\alpha_x(V) + \beta_x(V)}
```"""

# ╔═╡ 500ece75-b54c-4246-87a9-18e5f651f2eb
md"""
...
# ╔═╡ ca5c0da0-ce90-48dd-86e9-e6593725e6c1
md"""
...
begin
	...
	E_L = -54.387   # Leak Nernst Potential (mV)
	
end

# ╔═╡ c3348256-549d-45d5-9857-f57b832bae6f

    @bind I_ext Slider(-50:2:100, default=0.0)
...
# ╔═╡ e8baa624-5da8-4ca4-954d-384009f69d26
...
# ╔═╡ d9a1e2de-255c-4f14-903f-11d83530a98d
begin
# Initial Conditions
...
# ╔═╡ d28704b4-3232-45da-9e43-229b7ced235b
begin
...
manifest_format = "2.0"
project_hash = "c0b4b5a38188625be3bb859e98f9ea595469be9c"
